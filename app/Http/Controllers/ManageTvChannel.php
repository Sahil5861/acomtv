...
class ManageTvChannel extends Controller
{
    ...
    {
        return view('admin.tvchannel.add');
    }
    ...
    public function add(Request $request)
    {
        ...
        $tvchannel->description = $request->description;
        $tvchannel->status = $request->status;

        if ($tvchannel->save()) {
            return back()->with('message', $request->id ? 'TvChannel updated successfully' : 'TvChannel added successfully');
        } else {
            return back()->with('message', $request->id ? 'TvChannel not updated' : 'TvChannel not added');
        }
    }
