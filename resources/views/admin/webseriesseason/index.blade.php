    ...
    <div class="row layout-top-spacing">
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
            <div class="widget widget-card-four">
                <div class="widget-content">
                    <div class="w-content">
                        <div class="w-info">
                            <p class=""><small>Total Web Series Season</small></p>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
            <div class="widget widget-card-four">
                <div class="widget-content">
                    <div class="w-content">
                        <div class="w-info">
                            <p class=""><small>Active Web Series Season</small></p>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
            <div class="widget widget-card-four">
                <div class="widget-content">
                    <div class="w-content">
                        <div class="w-info">
                            <p class=""><small>Inactive Web Series Season</small></p>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
            <div class="widget widget-card-four">
                <div class="widget-content">
                    <div class="w-content">
                        <div class="w-info">
                            <p class=""><small>Deleted Web Series Season</small></p>
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            ...
            <div class="widget-content widget-content-area br-6">
                ...
                @endif
                <?php
                    $webseries = \App\Models\WebSeries::where('id',$id)->first();
                ?>
                <div class="text-left">
                    <p>
                        <a href="{{route('admin.webseries')}}">{{strtoupper('Websereis')}}</a>&nbsp; &gt;
                        <a href="{{route('admin.webseries.seasons', base64_encode($id))}}">{{ strtoupper($webseries->name)}}</a> 
                    </p>
                </div>
  ...
  <script type="text/javascript">
    $(document).ready(function(){        
      ...
      $('#multi-column-ordering').DataTable({
         ...
         serverSide: true,
         order: [[0, 'asc']],
         ajax: "{{route('getWebseriesSeasonList', $id)}}",
         columns: [
            { data: 'Session_Name' }, 
            { data: 'banner' },
            { data: 'status' },
    ...
    function delete_row(){
        ...
        $.ajax({
            type: 'POST',
            url: "{{route('webseries-season.destroy')}}",
            data: {
                _token: '{{ csrf_token() }}',
                id:id
            },
