...
@section('page', 'Webseries Seasons  /  Order List')
...
<div class="layout-px-spacing">
    <div class="row" id="cancel-row">
        <div class="col-lg-12 layout-spacing layout-top-spacing">
            <form id="order-form" method="post" action="{{ route('saveWebseriesSeasonsOrder') }}" enctype="multipart/form-data" novalidate class="simple-example">
                @csrf
                <div class="statbox widget box box-shadow">
                    <div class="widget-header">
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                <h4>Set Seasons Order</h4>
                            </div>           
                        </div>
                    </div>
                                    ...
                                    <div id='left-defaults' class="row">
                                        ...
                                        <div class="col-sm-3 d-md-flex d-block" id="main_div_{{$key}}" style="padding: 5px;">
                                            <div class="media d-md-flex d-block text-sm-left text-center" style="padding: 5px; border: 1px solid; padding: 5px 10px; border-radius: 5px; width: 100%;">
                                                <span id="ch_{{$key}}" class="c-index" style="position: absolute;left: 10px;top: 9px;">{{$dcl->season_order}}</span>
                                                ...
                                                <div class="media-body">
                                                    <div class="d-xl-flex d-block justify-content-between" style="position: relative;">
                                                        <div style="width: 100%; margin-left: 15px;">
                                                            <h6 style="margin-bottom: 3px; font-size: 12px">{{ $dcl->Session_Name }}</h6>
