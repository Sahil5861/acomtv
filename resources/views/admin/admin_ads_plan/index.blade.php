        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
            <div class="widget widget-card-four">
                <div class="widget-content">
                    <div class="w-content">
                        <div class="w-info">
                            <p class=""><small>Total Admin Ads</small></p>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
            <div class="widget widget-card-four">
                <div class="widget-content">
                    <div class="w-content">
                        <div class="w-info">
                            <p class=""><small>Active Admin Ads</small></p>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
            <div class="widget widget-card-four">
                <div class="widget-content">
                    <div class="w-content">
                        <div class="w-info">
                            <p class=""><small>Inactive Admin Ads</small></p>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
            <div class="widget widget-card-four">
                <div class="widget-content">
                    <div class="w-content">
                        <div class="w-info">
                            <p class=""><small>Deleted Admin Ads</small></p>
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            ...
            <div class="widget-content widget-content-area br-6">
                ...
                <div class="text-right">
                    <a href="{{url('admin-ads-add')}}" class="btn btn-primary mb-2">Add +</a>
                </div>
...
@section('footer')
  <script type="text/javascript">
    ...
    function delete_row(){
        ...
        $.ajax({
            type: 'POST',
            url: "{{route('admin.admin.ads.remove')}}",
            data: {
                _token: '{{ csrf_token() }}',
                id:id
            },
