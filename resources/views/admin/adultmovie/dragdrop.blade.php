...
<div class="layout-px-spacing">
    ...
    <div class="row" id="cancel-row">
        <div class="col-lg-12 layout-spacing layout-top-spacing">
            <form id="order-form"  method="post" action="{{route('saveAdultMovieOrders')}}" enctype="multipart/form-data" novalidate class="simple-example" >
                @csrf
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        ...
                        <div class='parent ex-1'>
                            <div class="row">
                                <input type="hidden" id="lockedChannels" name="lockedChannels" value="{{json_encode($lockedChannels)}}" />
                                ...
                                <div class="col-sm-12" class='dragula' id="_dragula" style="height: 400px;overflow-y: auto;border: 2px solid #828282">
                                    <div id='left-defaults' class="row" >
                                        ...
                                        <div class="col-sm-3 d-md-flex d-block @if($dcl->position_locked == 1) no-move @endif @if($dcl->position_locked == 0) move @endif" id="main_div_{{$key}}" style="padding: 5px;">
                                            <div class="media d-md-flex d-block text-sm-left text-center" style="padding: 5px;border: 1px solid; padding: 5px 10px;border-radius: 5px;width: 100%;">
                                                ...
                                                <!-- <img alt="avatar" src="{{asset('images/channel/'.$dcl->channel_logo)}}" class="img-fluid " style="width: 60px;margin-right: 5px;"> -->
                                        ...
                                        <div class="col-sm-3 d-md-flex d-block no-move" id="main_div_{{$key}}" style="padding: 5px;">
                                            <div class="media d-md-flex d-block text-sm-left text-center" style="padding: 5px;border: 1px solid; padding: 5px 10px;border-radius: 5px;width: 100%;">
                                                 <span id="ch_{{$key}}" class="c-index" style="position: absolute;left: 10px;top: 15px;">{{$key}}</span>
