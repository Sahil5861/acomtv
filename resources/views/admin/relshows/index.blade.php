    ...
    <div class="row layout-top-spacing">
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            ...
            <div class="widget-content widget-content-area br-6">
                ...
                <?php                     
                    $rel_show = \App\Models\RelChannel::where('id', $id)->first();                    
                ?>
                
                <div class="text-left">
                    <p>
                        <a href="{{route('admin.RelChannel')}}">{{strtoupper('Religious Channels')}}</a>&nbsp; &gt;                        
                        <a href="{{route('admin.Relshows', base64_encode($rel_show->id))}}">{{strtoupper($rel_show->name)}}</a>&nbsp; &gt;                        
                    </p>
                </div>
                
                <div class="text-right">
                    <a href="{{url('relegious-show-order',base64_encode($id))}}" class="btn btn-primary mb-2">Order Shows</a>                    
                    <a href="{{route('admin.Relshows.add', base64_encode($id))}}" class="btn btn-primary mb-2">Add +</a>
                </div>
