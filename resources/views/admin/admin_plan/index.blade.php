...
@section('mytitle', 'Admin Packages List')
@section('page', 'Admin Packages  /  List')
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            ...
            <div class="widget-content widget-content-area br-6">
                ...
                <div class="text-right">
                    <a href="{{url('add-admin-plan')}}" class="btn btn-primary mb-2">Add +</a>
                </div>
