...
<div class="layout-px-spacing">
    <div class="row" id="cancel-row">
        <div class="col-lg-12 layout-spacing layout-top-spacing">
            <form id="order-form" method="post" action="{{ route('saveKidsShowSeasonOrders') }}" enctype="multipart/form-data" novalidate class="simple-example">
                @csrf
                                                ...
                                                <div class="media-body">
                                                    <div class="d-xl-flex d-block justify-content-between" style="position: relative;">
                                                        <div style="width: 100%; margin-left: 15px;">
                                                            <h6 style="margin-bottom: 3px; font-size: 12px">{{ $dcl->season_name}}</h6>
