    ...
    <div class="row layout-top-spacing">
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
            <div class="widget widget-card-four">
                <div class="widget-content">
                    <div class="w-content">
                        <div class="w-info">
                            <p class=""><small>Total Kid Shows Season</small></p>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
            <div class="widget widget-card-four">
                <div class="widget-content">
                    <div class="w-content">
                        <div class="w-info">
                            <p class=""><small>Active Kid Shows Season</small></p>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
            <div class="widget widget-card-four">
                <div class="widget-content">
                    <div class="w-content">
                        <div class="w-info">
                            <p class=""><small>Inactive Kid Shows Season</small></p>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
            <div class="widget widget-card-four">
                <div class="widget-content">
                    <div class="w-content">
                        <div class="w-info">
                            <p class=""><small>Deleted Kid Shows Season</small></p>
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            ...
            <div class="widget-content widget-content-area br-6">
                ...
                @endif
                <?php
                    $show = \App\Models\KidsShow::where('id',$id)->first();
                ...
                <div class="text-right">
                    <a href="{{ route('admin.kidsshowseason.order', base64_encode($id)) }}" class="btn btn-primary mb-2">Order Seasons</a>
                    <a href="{{url('add-kid-shows-season/'.base64_encode($id))}}" class="btn btn-primary mb-2">Add +</a>
                </div>
  ...
  <script type="text/javascript">
    $(document).ready(function(){        
      ...
      $('#multi-column-ordering').DataTable({
         ...
         serverSide: true,
         order: [[0, 'asc']],
         ajax: "{{route('getKidShowsSeasonList', $id)}}",
         columns: [
            { data: 'season_name' }, 
            { data: 'banner' },
            { data: 'status' },
    ...
    function delete_row(){
        ...
        $.ajax({
            type: 'POST',
            url: "{{route('tvshows-season.destroy')}}",
            data: {
                _token: '{{ csrf_token() }}',
                id:id
            },
