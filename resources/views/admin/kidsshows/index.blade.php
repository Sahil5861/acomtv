    ...
    <div class="row layout-top-spacing">
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            ...
            <div class="widget-content widget-content-area br-6">
                ...
                <?php 
                    $channel_id = $id;
                    $channel = \App\Models\KidsChannel::where('id', $channel_id)->first();                    
                ?>
                
                <div class="text-left">
                    <p>
                        <a href="{{route('admin.kidschannel')}}">{{strtoupper('Kids Channels')}}</a>&nbsp; &gt;                        
                        <a href="{{route('admin.kidsshows', base64_encode($channel_id))}}">{{strtoupper($channel->name)}}</a>&nbsp; &gt;                        
                    </p>
                </div>
                
                <div class="text-right">
                    <a href="{{route('admin.kidsshow.order', base64_encode($id))}}" class="btn btn-primary mb-2">Order Shows</a>
                    <a href="{{route('admin.kidsshows.add', base64_encode($id))}}" class="btn btn-primary mb-2">Add +</a>
                </div>
