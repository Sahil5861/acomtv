        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <div class="widget-content widget-content-area br-6">
                @if(session()->has('message'))
                  ...
                  @endif
                <!-- <div class="row"> -->
                    <form id="user-form"  method="post" action="{{route('saveResellerWallet')}}" enctype="multipart/form-data" novalidate class="simple-example" >
                        @csrf
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6 mb-4">
                                <label for="fullName">Select Reseller</label>
