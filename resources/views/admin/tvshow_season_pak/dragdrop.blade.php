...
@section('mytitle', 'Tv Shows Seasons List')
@section('page', 'Tv Shows Seasons  /  Order List')
...
<div class="layout-px-spacing">
    <div class="row" id="cancel-row">
        <div class="col-lg-12 layout-spacing layout-top-spacing">
            <form id="order-form" method="post" action="{{ route('saveTvShowPakSeasonOrders') }}" enctype="multipart/form-data" novalidate class="simple-example">
                @csrf
