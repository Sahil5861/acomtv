...
@section('page', 'Show Episode  /  Order List')
...
<div class="layout-px-spacing">
    <div class="row" id="cancel-row">
        <div class="col-lg-12 layout-spacing layout-top-spacing">
            <form id="order-form" method="post" action="{{ route('saveTvShowEpisodesOrders') }}" enctype="multipart/form-data" novalidate class="simple-example">
                @csrf
