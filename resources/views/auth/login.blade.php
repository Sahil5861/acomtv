            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <h1 class="">Log In to <a href="index.html"><span class="brand-name">ACOM TV</span></a></h1>
                        <!-- <p class="signup-link">New Here? <a href="auth_register.html">Create an account</a></p> -->
                        <form method="post" action="{{ route('login.perform') }}"class="text-left">
                            ...
                            <div class="form">
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="email" name="email" value="{{ old('email') }}" type="text" class="form-control" placeholder="Email" autocomplete="off">
                                    @if ($errors->has('email'))
                                ...
                                <div id="password-field" class="field-wrapper input mb-2">
                                    ...
                                    <input id="password" name="password" type="password"  value="{{ old('password') }}" class="form-control" placeholder="Password" autocomplete="off">
                                ...
                                <div class="field-wrapper">
                                    <a href="{{route('forget.password.get')}}" class="forgot-pass-link">Forgot Password?</a>
                                </div>
